    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        updateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String updateabout= about.getText().toString();
                ...
                uploadProfileImage();
                updateDoctorInfos(updateName, updateAddress, updatePhone,updateabout);
            }
        });
    }

    /* Update the doctor info in the database */
    private void updateDoctorInfos(String name, String address, String phone,String about) {
